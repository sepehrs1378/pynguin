...
class TestCaseChromosome(chrom.Chromosome):
    ...
    def cross_over(  # noqa: D102
        ...
        assert isinstance(other, TestCaseChromosome), "Cannot perform crossover with " + str(type(other))
        ...
        for j in range(position2, other.test_case.size()):
            self._test_factory.append_statement(offspring_test_case, other.test_case.get_statement(j))
